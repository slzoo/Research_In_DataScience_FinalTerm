...
def attack_example(attack_class):
    ...
    generator = datagen.flow_from_directory(
            ...
            batch_size=150,
            class_mode='binary')
    predict = target_model.predict_generator(generator, steps=30)
    """
    generator = datagen.flow_from_directory(
            '../samples/dataset/test',
            target_size=(299,299),
    ...
    for filename in filenames:
        trojannet.evaluate_backdoor_model(target_model=target_model, img_path='mal.png', inject_pattern=image_pattern, gen=generator, filename=filename, pred_gen=predict)
